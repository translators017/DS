    ...
    <section class="vwh-100 min-h-300 max-h-600 d-flex align-items-center justify-content-center">
        <div class="container">
            ...
            <div class="items-box border">
                <h2 class="text-center mb-30">Data Migrator</h2>
                <div class="card-deck justify-content-center CardP-0">
                    <div class="card card3d max-w-250" onclick="onDataCatalogClick()">
                        ...
                        <a class="card-body text-center" href="#">
                            <div class="face face1">
                                <div class="content">
                                    <img class="rounded-circle" src="<%=request.getContextPath()%>/resources/images/v1_02/Job_Designer.png" alt="Data Catalog">
                                    <h3>Job Designer</h3>
                                </div>
                            </div>
                    ...
                    <div class="card card3d max-w-250">
                        <a class="card-body text-center" href="#">
                            <div class="face face1">
                                <div class="content">
                                    <img class="rounded-circle" src="<%=request.getContextPath()%>/resources/images/v1_02/Job_Execution.png" alt="Schema Designer ">
                                    <h3>Job Execution</h3>
                                </div>
                            </div>
                            <div class="face face2">
                    ...
                    <div class="card card3d max-w-250">
                        <a class="card-body text-center" href="#">
                            <div class="face face1">
                                <div class="content">
                                    <img class="rounded-circle" src="<%=request.getContextPath()%>/resources/images/v1_02/Job_Monitor.png" alt="Data Mapper">
                                    <h3>Job Monitor</h3>
                                </div>
                            </div>
                            <div class="face face2">
                    ...
                    <div class="card card3d max-w-250">
                        <a class="card-body text-center" href="#">
                            <div class="face face1">
                                <div class="content">
                                    <img class="rounded-circle" src="<%=request.getContextPath()%>/resources/images/v1_02/Job_Validation.png" alt="Data Mapper">
