    ...
    <section class="vwh-100 min-h-300 d-flex align-items-center justify-content-center">
        <div class="container">
            ...
            <div class="items-box border">
                <h2 class="text-center mb-30">Data Switch - ADMIN</h2>
                <div class="card-deck justify-content-center CardP-0">
	
                    <div class="card card3d max-w-250" onclick="onMigrateClick()">
                        <!--  <a class="card-body text-center" href="<%=request.getContextPath()%>/WEB-INF/views/"> -->
                        <a class="card-body text-center" href="<%=request.getContextPath()%>/migrate">
                            <div class="face face1">
                                <div class="content">
                                    <img class="rounded-circle" src="<%=request.getContextPath()%>/resources/images/DS_Migrate.png" alt="DS:Migrate">
                                    <h3>Migrate</h3>
                                </div>
                            </div>
                    ...
                    <div class="card card3d max-w-250">
                        <a class="card-body text-center" href="#">
                            <div class="face face1">
                                <div class="content">
                                    <img class="rounded-circle" src="<%=request.getContextPath()%>/resources/images/DS_Integrate.png" alt="DS:Integrate">
                                    <h3>Integrate</h3>
                                </div>
                            </div>
                            <div class="face face2">
                    ...
                    <div class="card card3d max-w-250">
                        <a class="card-body text-center" href="#">
                            <div class="face face1">
                                <div class="content">
                                    <img class="rounded-circle" src="<%=request.getContextPath()%>/resources/images/DS_Democratize.png" alt="DS:Democratize">
                                    <h3>Democratize</h3>
                                </div>
                            </div>
	        ...
	        function onMigrateClick(){
	       		/*$.ajax({
	    			...
	    			success:function(data){
	    				var insertText = data;
	    			    console.log('Migrate Launch Success: ',data);
	    			}
	    			//success:callback
	    		});*/
				
				//let fromPage = 'Migrate';
				//$('#grpNmForMigrateView').val(fromPage);
				//$('#launchMigrate').submit();
	       	}
        </script>
</body>
</html>