...
public class CreatePostSqlComp {

	public static void createSrcForPostSQL(TalendfileProcessType pipeline, TransRecExtDTO recordperPipe, Connector docspecs, Node compNode,String postSQL, SrcTgtInfo srctgtdb, String szoutputLinkedServiceFilePath, DataMapping dataMappingObj,List<String> cntxtParamsList) {
		...
		else
		{
			...
			{
				compVersion = 0.102;
				fillPropforDBSrc(recordperPipe, docspecs, compNode, srctgtdb,szoutputLinkedServiceFilePath, cntxtParamsList,postSQL,compName);
			}
			else if(srctgtdb.fileType.equalsIgnoreCase("Relational - Snowflake DW"))
			{
				compVersion = 0.102;
				fillPropforDBSnowFlakeSrc(recordperPipe, docspecs, compNode, srctgtdb,szoutputLinkedServiceFilePath,cntxtParamsList,dataMappingObj,postSQL,compName);
			}
		}
		...
		conn.setlineStyle("1");
		conn.setmetaname(recordperPipe.compName);
		conn.setoffsetLabelX("0");
		conn.setoffsetLabelY("0");
		conn.setsource(recordperPipe.compName);
		conn.settarget(compName);
...
//					colDTO.get(0).colStruct.name;
	...
	public static void fillPropforDBSrc(TransRecExtDTO recordperPipe,Connector docspecs,Node compNode,SrcTgtInfo srctgtdb,String szoutputLinkedServiceFilePath, List<String> cntxtParamsList, String postSQL, String compName)
	{
...
//				"&quot;&quot;","get from reclist",tlndTranstype.toLowerCase()+"_id","&quot;ISO-8859-15&quot;","ISO-8859-15","false","1000","false",""};
	...
	public static void fillPropforDBSnowFlakeSrc(TransRecExtDTO recordperPipe, Connector docspecs, Node compNode,
			SrcTgtInfo srctgtdb, String szoutputLinkedServiceFilePath, List<String> cntxtParamsList, DataMapping dataMappingObj, String postSQL, String compName) 
	{
		ArrayList<ElementParameter> elemParam = new ArrayList<ElementParameter>();
